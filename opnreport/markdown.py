#!/usr/bin/env python3
from opnreport.opnsense import OpnSenseNode, OpnSenseRuleAlias, OpnSenseRuleInterface, OpnSenseRuleLocation
from opnreport.util import dict_to_list, obj_to_dict, obj_to_list, hasattr_r
